...
class NotesConfig 
{
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('additionalFields', $value)) {
            $this->_usedProperties['additionalFields'] = true;
            $this->additionalFields = array_map(fn ($v) => new \Symfony\Config\Pimcore\WorkflowsConfig\GlobalActionsConfig\Notes\AdditionalFieldsConfig($v), $value['additionalFields']);
