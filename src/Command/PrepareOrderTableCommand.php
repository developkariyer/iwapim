    ...
    protected static function transferOrdersEtsy($marketPlaceId,$marketplaceType)
    {
        $etsySql = "
            ...
            SELECT
                ...
                FROM_UNIXTIME(JSON_UNQUOTE(JSON_EXTRACT(json, '$.created_timestamp')) / 1000) AS created_at,
                FROM_UNIXTIME(JSON_UNQUOTE(JSON_EXTRACT(json, '$.updated_timestamp')) / 1000) AS closed_at,         
