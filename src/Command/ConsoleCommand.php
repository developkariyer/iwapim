...
use App\Connector\Marketplace\ShopifyConnectorREST;
...
class ConsoleCommand extends AbstractCommand
{
    ...
    {   // $this->setShopifySku();
        ...
        $shopifyConnectors = [
            23978 => new ShopifyConnectorREST(Marketplace::getById(23978)),
            84124 => new ShopifyConnectorREST(Marketplace::getById(84124)),
            108415 => new ShopifyConnectorREST(Marketplace::getById(108415)),
            108416 => new ShopifyConnectorREST(Marketplace::getById(108416)),
            108417 => new ShopifyConnectorREST(Marketplace::getById(108417)),
            108418 => new ShopifyConnectorREST(Marketplace::getById(108418)),
            108419 => new ShopifyConnectorREST(Marketplace::getById(108419)),
        ];
