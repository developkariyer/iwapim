...
//        }
    ...
    public function dropshipOrderTest()
    {
        $query = <<<GRAPHQL
    ...
    //    }
        ...
        //$this->sendShipmentSandbox(275550, 'TEST_11620177', 'ASH_P384_MOUNTVALLEYDINING');
    ...
    public function sendShipmentSandbox($supplierId, $poNumber, $partNumber, )
    {
        ...
        $variables = [
            'notice' => [
                ...
                'shipDate' => '2025-07-30 06:46:31.000000 +00:00',
                'sourceAddress' => [
                    'name' => 'John Smith',
