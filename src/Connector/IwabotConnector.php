...
class IwabotConnector
{
    ...
    {
        $db = \Pimcore\Db::get();
        $sql = "INSERT INTO iwa_inventory (inventory_type, warehouse, asin, fnsku, json_data, total_quantity, created_updated_at) VALUES ('IWA', 'NJ', ?, ?, ?, ?, NOW()) ON DUPLICATE KEY UPDATE json_data = ?, total_quantity = ?, created_updated_at = NOW()";
