DO "Step 1: Create temp_sales_data temporary table";
...
DO "Step 2: Create temp_expanded_sales temporary table";
...
DO "Step 3: Create temp_daily_sales temporary table";
...
DO "Step 4: Generate the full date range in temp_all_dates";
...
DO "Step 5: Create temp_expanded_asin_sales_channel";
...
DO "Step 6: Combine all data into iwa_amazon_daily_sales_summary_temp";
...
DO "Step 9: Drop the existing table and rename the temporary table";
...
DO "Step 10: Add indexes for faster querying";
